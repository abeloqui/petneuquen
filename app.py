    ...
    # ===================== NUEVA PUBLICACIÓN (CORREGIDA) =====================
        ...
        with st.form("upload_form", clear_on_submit=True):
            ...
            with col2:
                ...
                lat = st.number_input("Latitud", value=st.session_state.get('temp_lat', -38.951), format="%.6f")
                lng = st.number_input("Longitud", value=st.session_state.get('temp_lng', -68.059), format="%.6f")
